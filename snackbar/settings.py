...
STATICFILES_DIRS = [
    BASE_DIR / "main" / "static",  # Points to main/static/ directory
]

# Directory where collected static files will be stored (for production)
STATIC_ROOT = BASE_DIR / "staticfiles"

# Static files storage for production (serves compressed files)
# Simpler configuration for troubleshooting
STATICFILES_STORAGE = 'django.contrib.staticfiles.storage.StaticFilesStorage'

# WhiteNoise will handle serving
